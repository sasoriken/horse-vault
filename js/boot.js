...
const LINES = [
  ...
  { msg: 'SYSTEM READY — WELCOME TO GALLOPMETRICS',          status: 'grant', delay: 1900 },
];
...
╚██████╔╝██║ ╚═╝ ██║███████╗   ██║
 ╚═════╝ ╚═╝     ╚═╝╚══════╝   ╚═╝
──────────  G A L L O P M E T R I C S  ──────────`.trim();

const SUBTITLE = 'THOROUGHBRED INTELLIGENCE  //  INSTITUTIONAL GRADE  //  v4.0';
